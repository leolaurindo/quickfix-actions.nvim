...
`QuickfixActionsLayout` defaults to the kind of the current native list. For
location lists, the owner is the current file window (or the owner of the current
location-list window). It reopens the same list, even when changing orientation.
